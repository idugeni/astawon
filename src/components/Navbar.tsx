...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-base-200 bg-base-100/80 shadow-lg backdrop-blur-md transition-all duration-300">
      <div className="navbar container-fluid mx-auto px-4">
        ...
        <div className="navbar-end">
          ...
          >
            ...
            <span className="ml-2 hidden sm:block text-sm md:text-base">Login</span>
          </Link>
        </div>
      </div>
