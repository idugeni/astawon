...
export default function DashboardLayout({
  ...
  const navLinks = [
    ...
    },
    {
      ...
      icon: <FaRegFileLines className='text-lg' />,
    },
    {
      name: 'Jadwal Berita',
      href: '/dashboard/jadwal-berita',
      icon: <FaCalendar className='text-lg' />,
    },
    {
      name: 'Analytics',
      href: '/dashboard/analytics',
      icon: <FaChartColumn className='text-lg' />,
    },
    {
      name: 'Settings',
    ...
    <div data-theme='night' className='drawer lg:drawer-open'>
      ...
      <div className='drawer-content flex flex-col'>
        ...
        <footer className='footer footer-center p-4 bg-base-300 text-base-content flex flex-col md:flex-row justify-between items-center'>
          <div className='flex flex-col md:flex-row w-full justify-between items-center md:items-center'>
            ...
            <div className='text-center md:text-right mt-2 md:mt-0'>
              <p className='font-medium'>
                ...
                <span className='text-primary'>Eliyanto Sarage</span>
              </p>
            </div>
          </div>
        </footer>
