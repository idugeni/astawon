...
import {
  FaReact, FaNodeJs, FaDatabase, FaCss3Alt, FaCloud, FaBrain, FaFacebook, FaXTwitter, FaInstagram, FaGithub,
} from "react-icons/fa6";
import Link from "next/link";
import { useMetadata } from "@/hooks/useMetadata";

export default function AboutPage() {
  useMetadata("About", "About page for ASTAWON platform");
  return (
    <div className="min-h-screen bg-base-200 p-8 sm:p-16 transition-all duration-700 ease-in-out">
      <section className="max-w-7xl mx-auto">
        ...
        <p className="leading-relaxed text-center mb-8">ASTAWON adalah platform digital yang dirancang untuk mempermudah pengelolaan informasi dan penyampaian perkembangan terkini tentang Rutan Wonosobo.</p>
