      ...
      <div className='card bg-base-100 shadow-xl mb-6'>
        <div className='card-body'>
          ...
          <p className='text-base-content/90'>
            ASTAWON (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is
            committed to protecting your privacy. This Privacy Policy explains
            how we collect, use, and safeguard your information when you use our
            digital platform designed for managing information and delivering
            updates related to Rutan Wonosobo.
          </p>
        </div>
      </div>
        ...
        <div className='card bg-base-100 shadow-xl'>
          <div className='card-body'>
            ...
            <ul className='list-disc pl-6 space-y-2'>
              <li>
                Personal identification data (name, email, contact details)
              </li>
      ...
      <div className='card bg-base-100 shadow-xl mt-6'>
        <div className='card-body'>
          ...
          <div className='alert alert-info'>
            <span>
              For data access or deletion requests, contact our Data Protection
              Officer at dpo@astawon.go.id
            </span>
          </div>
        </div>
      </div>
